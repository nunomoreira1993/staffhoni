...
<head>
    ...
    <title>Honi - Gestão de RP's &amp; Promotores</title>
...
<body>
    <div class="topo">
        ...
        <h1 class="venda"> VENDA DE PRIVADOS </h1>
    </div>
    <div class="cabecalho">
        <div class="esquerda">
            <div class="bloco">
            ...
            <div class="bloco">
                ...
                <span class="valor">
                    <?php echo $venda['sala']; ?> - <?php echo strtoupper($venda['mesa']); ?>
                </span>
            </div>
            <div class="bloco">
                <span class="label">
    ...
    <div class="total">
        ...
        <div class="valor">
            <?php echo euro($venda['total_venda']); ?>
        </div>
    </div>
